/*
  Project: Smart Money Tracking (FET & RNDR)
  Description: This query identifies high-value addresses (candidates) by:
    1. Filtering token transfers for FET (Ethereum) and RNDR (Solana).
    2. Calculating daily net flows per address.
    3. Applying a p80 (80th percentile) threshold on net flows to identify significant movers.
    4. Ensuring a minimum activity period (10 days) and net flow amount ($1000).
*/
